...
# تنظیمات اولیه
TOKEN = os.getenv("8255151341:AAGFwWdSGnkoEVrTOej0jaNUco-DmgKlbCs")  # توکن ربات در متغیر محیطی
CHANNEL_ID = -1002276225309     # آیدی کانال VIP
ADMIN_ID = 368422936            # آیدی ادمین
WEBHOOK_URL = "https://appleid035.onrender.com"  # آدرس رندر واقعی
...
if __name__ == "__main__":
    # برای تست محلی (یا می‌تونی حذفش کنی و فقط روی Render وبهوک داشته باشی)
